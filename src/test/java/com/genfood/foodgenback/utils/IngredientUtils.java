...
public class IngredientUtils {
    ...
    public static Ingredients ig1() { return Ingredients.builder().id(IG1_ID).name(IG1_NAME).build(); }
    public static Ingredients ig2() { return Ingredients.builder().id(IG2_ID).name(IG2_NAME).build(); }
    public static Ingredients ig3() { return Ingredients.builder().id(IG3_ID).name(IG3_NAME).build(); }
    public static Ingredients updatedIg3() { return Ingredients.builder().id(IG3_ID).name(UPDATED_IG3_NAME).build(); }
}
